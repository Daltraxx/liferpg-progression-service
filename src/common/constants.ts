 ...
 * experienceRequired = BASE_ATTRIBUTE_LEVEL_EXP * (level ^ ATTRIBUTE_LEVEL_EXPONENT_STEEPNESS)
 * To calculate the level for a given amount of experience, you can use the inverse of this formula:
 * level = Math.floor((experience / BASE_ATTRIBUTE_LEVEL_EXP) ^ (1 / ATTRIBUTE_LEVEL_EXPONENT_STEEPNESS))
 */
export const BASE_ATTRIBUTE_LEVEL_EXP = 10;
